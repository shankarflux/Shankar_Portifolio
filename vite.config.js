...
export default defineConfig({
  plugins: [react()],
  // 'root' is removed or commented out because index.html is now in the project root.
  // Vite defaults to the current working directory as the root.

  // Configure base for GitHub Pages deployment
  // Replace '/Shankar_Portifolio/' with your actual repository name if different
